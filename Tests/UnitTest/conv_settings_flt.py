...
def _build_cases() -> list[ConvCaseFlt]:
    base_cases = [
        ...
        ConvCaseFlt(
            dataset="conv_k5_batch2_rows2_tails_null_bias_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=2,
        ...
        ConvCaseFlt(
            dataset="conv_k2_packed_valid_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
        ...
        ConvCaseFlt(
            dataset="conv_2x3_packed_valid_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
        ...
        ConvCaseFlt(
            dataset="conv_2x5_packed_valid_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
