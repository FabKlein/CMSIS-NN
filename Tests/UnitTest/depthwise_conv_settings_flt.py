...
def _build_cases() -> list[DepthwiseConvCaseFlt]:
    base_cases = [
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k9_1d_opt_nhwc_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=True,
            batches=1,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k9_1d_mult3_batch2_null_bias_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=True,
            batches=2,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k9_1d_mult9_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=True,
            batches=1,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k2_1d_opt_nhwc_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k5_1d_opt_nhwc_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_k7_1d_opt_nhwc_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
        ...
        DepthwiseConvCaseFlt(
            dataset="depthwise_2x3_opt_nhwc_f32",
            dtype_name="f32",
            layout="nhwc",
            use_wrapper=False,
            batches=1,
    ...
    # Keep f16 data regenerable from the same shape catalogue as f32.
    f16_cases = [
