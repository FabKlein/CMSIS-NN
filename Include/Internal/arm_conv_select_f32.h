 ...
 * Title:        arm_conv_select_f32.h
 * Description:  Internal F32 specialized convolution selection
 *
...
#ifndef ARM_CONV_SELECT_F32_H
#define ARM_CONV_SELECT_F32_H
...
typedef void (*arm_conv_1d_kernel_f32)(const float32_t *,
                                       int32_t,
                                       int32_t,
                                       const float32_t *,
                                       const float32_t *,
...
typedef void (*arm_conv_2d_kernel_f32)(const float32_t *,
                                       int32_t,
                                       int32_t,
                                       int32_t,
                                       const float32_t *,
...
typedef struct
{
    ...
    bool is_1d;
    bool packed;
} arm_conv_selection_f32;

/* Exactly one function is set when resolving a successful selection. */
typedef struct
{
    arm_conv_1d_kernel_f32 kernel_1d;
    arm_conv_2d_kernel_f32 kernel_2d;
} arm_conv_kernels_f32;
