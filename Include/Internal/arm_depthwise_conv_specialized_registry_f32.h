 ...
 * Title:        arm_depthwise_conv_specialized_registry_f32.h
 * Description:  F32 specialized depthwise convolution registry
 *
...
ARM_DW_SPEC(1,
            9,
            arm_dw_spec_k9_1d_nhwc_f32_call,
