 ...
 * Title:        arm_nn_conv1d_packed_f32_template.h
 * Description:  Float32 adapter for packed 1D convolution template
 *
...
/*
 * F32 adapter for the shared packed 1D convolution template.
 ...
 */
#define ARM_NN_CONV1D_PACKED_SCALAR_T float32_t
/* Preserve single-precision scalar accumulation for the k7/k9 kernels. */
#define ARM_NN_CONV1D_PACKED_ACCUMULATOR_T float32_t
#define ARM_NN_CONV1D_PACKED_LANES 4

#if defined(ARM_MATH_MVEF) && !defined(ARM_MATH_AUTOVECTORIZE)
    #define ARM_NN_CONV1D_PACKED_USE_MVE 1
    #define ARM_NN_CONV1D_PACKED_VECTOR_T float32x4_t
    #define ARM_NN_CONV1D_PACKED_ZERO() vdupq_n_f32(0.0f)
    #define ARM_NN_CONV1D_PACKED_PREDICATE vctp32q
#else
