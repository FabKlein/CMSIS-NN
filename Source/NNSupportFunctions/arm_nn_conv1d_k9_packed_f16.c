 ...
 * Title:        arm_nn_conv1d_k9_packed_f16.c
 * Description:  Support: NHWC 1D convolution kernel size 9 for packed f16 weights
 *
 * $Date:        22 Jun 2026
 * $Revision:    V.1.0.0
 *
                                 ...
                                 int32_t out_w)
{
    ...
    for (; ow + 5 < out_w; ow += 6)
    {
        ...
        const float16_t *x12 = x_nhwc + (size_t)(ow + 12) * (size_t)in_c;
        const float16_t *x13 = x_nhwc + (size_t)(ow + 13) * (size_t)in_c;
        const float16_t *x14 = x_nhwc + (size_t)(ow + 14) * (size_t)in_c;
        ...
        {
            const float16_t *w_base = kernel_packed + ((size_t)oc / block_cols) * 9U * (size_t)in_c * block_cols;
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                const float16_t sx12 = x12[ic];
                const float16_t sx13 = x13[ic];
                const float16_t sx14 = x14[ic];
                ...
                vw = vld1q(w_ic + 7U * in_c * block_cols);
                vacc0 = vfmaq(vacc0, vw, sx7);
                vacc1 = vfmaq(vacc1, vw, sx8);
                vacc2 = vfmaq(vacc2, vw, sx9);
                vacc3 = vfmaq(vacc3, vw, sx10);
                vacc4 = vfmaq(vacc4, vw, sx11);
                vacc5 = vfmaq(vacc5, vw, sx12);
                vw = vld1q(w_ic + 8U * in_c * block_cols);
                vacc0 = vfmaq(vacc0, vw, sx8);
                vacc1 = vfmaq(vacc1, vw, sx9);
                vacc2 = vfmaq(vacc2, vw, sx10);
                vacc3 = vfmaq(vacc3, vw, sx11);
                vacc4 = vfmaq(vacc4, vw, sx12);
                vacc5 = vfmaq(vacc5, vw, sx13);
            }
        ...
        if (oc < out_c)
        {
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                vacc4 = vfmaq(vacc4, vw, sx10);
                vacc5 = vfmaq(vacc5, vw, sx11);
                vw = vld1q_z(w_ic + 7U * in_c * block_cols, p);
                vacc0 = vfmaq(vacc0, vw, sx7);
                vacc1 = vfmaq(vacc1, vw, sx8);
                vacc2 = vfmaq(vacc2, vw, sx9);
                vacc3 = vfmaq(vacc3, vw, sx10);
                vacc4 = vfmaq(vacc4, vw, sx11);
                vacc5 = vfmaq(vacc5, vw, sx12);
                vw = vld1q_z(w_ic + 8U * in_c * block_cols, p);
                vacc0 = vfmaq(vacc0, vw, sx8);
                vacc1 = vfmaq(vacc1, vw, sx9);
                vacc2 = vfmaq(vacc2, vw, sx10);
                vacc3 = vfmaq(vacc3, vw, sx11);
    ...
    for (; ow + 1 < out_w; ow += 2)
    {
        ...
        for (; oc + block_cols <= out_c; oc += block_cols)
        {
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                vw = vld1q(w_ic + 7U * in_c * block_cols);
                vacc0 = vfmaq(vacc0, vw, x7[ic]);
                vacc1 = vfmaq(vacc1, vw, x8[ic]);
                vw = vld1q(w_ic + 8U * in_c * block_cols);
                vacc0 = vfmaq(vacc0, vw, x8[ic]);
                vacc1 = vfmaq(vacc1, vw, x9[ic]);
            }
    ...
    if (ow < out_w)
    {
        ...
        for (; oc + block_cols <= out_c; oc += block_cols)
        {
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                vacc = vfmaq(vacc, vld1q(w_ic + 7U * in_c * block_cols), x7[ic]);
                vacc = vfmaq(vacc, vld1q(w_ic + 8U * in_c * block_cols), x8[ic]);
            }
        ...
        if (oc < out_c)
        {
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                vacc = vfmaq(vacc, vld1q_z(w_ic + 7U * in_c * block_cols, p), x7[ic]);
                vacc = vfmaq(vacc, vld1q_z(w_ic + 8U * in_c * block_cols, p), x8[ic]);
            }
    ...
    for (int32_t ow = 0; ow < out_w; ++ow)
    {
        ...
        for (int32_t oc = 0; oc < out_c; ++oc)
        {
            ...
            for (int32_t ic = 0; ic < in_c; ++ic)
            {
                ...
                acc += (_Float16)x7[ic] * (_Float16)w_ic[(size_t)7 * in_c * block_cols + lane];
                acc += (_Float16)x8[ic] * (_Float16)w_ic[(size_t)8 * in_c * block_cols + lane];
            }
