 ...
 * Title:        arm_nn_conv_select_f16.c
 * Description:  Table-based F16 specialized convolution selection
 *
 ...
 */
static const arm_conv_specialized_candidate arm_conv_1d_available_f16[] = {
...
static const arm_conv_specialized_candidate arm_conv_2d_available_f16[] = {
    #define ARM_CONV_1D_SPEC(W, PACKED, STANDARD, ...)
                                     ...
                                     arm_conv_selection_f16 *selection)
{
    ...
    const arm_conv_specialized_candidate *candidates = is_1d ? arm_conv_1d_available_f16 : arm_conv_2d_available_f16;
    const size_t count =
        is_1d ? ARM_CONV_ARRAY_SIZE(arm_conv_1d_available_f16) : ARM_CONV_ARRAY_SIZE(arm_conv_2d_available_f16);
