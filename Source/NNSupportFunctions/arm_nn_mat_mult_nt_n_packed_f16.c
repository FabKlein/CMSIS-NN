                                                    ...
                                                    float16_t activation_max)
{
    ...
    for (; r + ARM_NN_MAT_MULT_NT_N_PACKED_F16_BLOCK_ROWS <= lhs_rows; r += ARM_NN_MAT_MULT_NT_N_PACKED_F16_BLOCK_ROWS)
    {
        ...
        for (int32_t b = 0; b < rhs_blocks; ++b)
        {
            ...
            float16x8_t vacc0 = arm_nn_load_optional_bias_z_f16(bias, c, p);
            float16x8_t vacc1 = arm_nn_load_optional_bias_z_f16(bias, c, p);
            float16x8_t vacc2 = arm_nn_load_optional_bias_z_f16(bias, c, p);
            float16x8_t vacc3 = arm_nn_load_optional_bias_z_f16(bias, c, p);
